...
try:
 ...
 for list1 in csv.reader(s.splitlines(), skipinitialspace=True):
    ...
    print("Error encountered") # apparently when sent over to other computers or people will cause the rest of the program rendered moot and only this line will activate
